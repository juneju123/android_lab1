...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cb.setOnCheckedChangeListener((c, b) -> {
            ...
            Snackbar.make(cb,cb.getResources().getString(R.string.snackbar_msg)+onOff,Snackbar.LENGTH_INDEFINITE).setAction( cb.getResources().getString(R.string.undo), click -> cb.setChecked(!b)).show();
        });
        ...
        sw.setOnCheckedChangeListener((c, b) -> {
           String onOff= b?sw.getResources().getString(R.string.on):sw.getResources().getString(R.string.off);
            Snackbar.make(cb,cb.getResources().getString(R.string.snackbar_msg)+onOff,Snackbar.LENGTH_INDEFINITE).setAction( cb.getResources().getString(R.string.undo), click -> sw.setChecked(!b)).show();
        });
